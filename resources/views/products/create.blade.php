...
<div class="content">
    ...
    <div>
        <div class="m-b-md">
            <a class="btn btn-primary" href="{{ route('products.index') }}">Back to Group Index</a>
        </div>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-product">
                ...
                {!! Form::text('customer_product_code', null, array('placeholder' => 'Product Name','class' => 'form-control')) !!}
            </div>
        </div>
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-product">
